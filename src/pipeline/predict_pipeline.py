...
class PredictionPipeline:
    def __init__(self,request: Request):
        ...
        self.prediction_pipleine_config = PredictionPipelineConfig()
    ...
    def predict(self, features):
        ...
        try:
            ...
            model = self.utils.load_object(self.prediction_pipleine_config.model_file_path)
            preprocessor = self.utils.load_object(file_path=self.prediction_pipleine_config.preprocessor_path)
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            os.makedirs(self.prediction_pipleine_config.prediction_output_dirname, exist_ok= True)

            input_dataframe.to_csv(self.prediction_pipleine_config.prediction_file_path, index = False)
